...
def main():
    config_path = "clean_transfer_tli_departure_config.yaml"
    ...
    for i, row in selected_df.iterrows():
        case_id = str(row.get("case_id", row.get("sample_id", i)))
        print(f"Optimizing case {i + 1}/{len(selected_df)}: {case_id}")
    ...
    # Representative trajectory saving/plotting
    representative_info = {}
